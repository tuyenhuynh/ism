...
require_once('/var/www/html/irrigation-scheduler/jpgraph_include/jpgraph-src/jpg-config.inc.php');
require_once('/var/www/html/irrigation-scheduler/jpgraph_include/jpgraph-src/jpgraph_gradient.php');
//require_once('/var/www/html/irrigation-scheduler/jpgraph_include/jpgraph-src/jpgraph_errhandler.inc.php');
//require_once('/var/www/html/irrigation-scheduler/jpgraph_include/jpgraph-src/jpgraph_ttf.inc.php');
//require_once('/var/www/html/irrigation-scheduler/jpgraph_include/jpgraph-src/jpgraph_rgb.inc.php');
//require_once('/var/www/html/irrigation-scheduler/jpgraph_include/jpgraph-src/jpgraph_text.inc.php');
//require_once('/var/www/html/irrigation-scheduler/jpgraph_include/jpgraph-src/jpgraph_legend.inc.php');
//require_once('/var/www/html/irrigation-scheduler/jpgraph_include/jpgraph-src/jpgraph_theme.inc.php');
//require_once('/var/www/html/irrigation-scheduler/jpgraph_include/jpgraph-src/gd_image.inc.php');
        ...
        if( !$_csim ) {
            ...
            if( $this->iImgTrans ) {
                if( !class_exists('ImgTrans',false) ) {
                    require_once('/var/www/html/irrigation-scheduler/jpgraph_include/jpgraph-src/jpgraph_imgtrans.php');
